...
export const TEAM: TeamMember[] = [
  {
    ...
    socials: { instagram: 'https://www.instagram.com/bernirodriguez5/', twitter: 'https://x.com/bernirodriguez5' }
  },
  {
    ...
    socials: { instagram: 'https://www.instagram.com/jmcalderon8/', twitter: 'https://x.com/JmCalderon' }
  },
  {
    name: 'Manuel Escobar',
    role: 'CEO',
    ...
    socials: { instagram: 'https://www.instagram.com/manuelcarlosel/' }
  },
  {
    name: 'Manuel Elena',
    role: 'Gerente de Instalaciones',
    description: 'Intersección entre tecnología y negocio. Desarrollador informático y marketing, gestión de la comunicación y el desarrollo digital. Gerente de las instalaciones de THE EMBASSY.',
    ...
    socials: { instagram: 'https://www.instagram.com/manu.melenamarketing/', twitter: 'https://x.com/Manolo_Ele' }
  },
  {
    name: 'Adriana Rodríguez',
    role: 'Especialista en rendimiento deportivo',
    description: 'Especialista en rendimiento deportivo. Aplica su experiencia profesional en el baloncesto élite para optimizar la salud física del jugador/a.',
    ...
    socials: { instagram: 'https://www.instagram.com/adrileslie/' }
  },
  {
    name: 'Alfonso Sánchez',
    role: 'Entrenador de desarrollo',
    description: 'Exjugador profesional con una destacada trayectoria en 5 clubes ACB. Actualmente, desempeña el rol de entrenador de desarrollo de jugadores y técnica individual.',
    ...
    socials: { instagram: 'https://www.instagram.com/23asanchez/', twitter: 'https://x.com/23ASanchez' }
  }
];
