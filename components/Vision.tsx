...
import { VISION_POINTS } from '../constants.tsx';
        ...
        <div className="relative group reveal">
          <div className="aspect-[4/5] rounded-[2rem] overflow-hidden shadow-[0_0_100px_rgba(212,140,0,0.1)] bg-neutral-900">
            <video 
              ...
              controls
              playsInline
              poster="https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1761950147664_TheEmbassyTC-imagen_050.jpg?alt=media&token=91bbf74f-6cad-4f7c-9bfb-8c020278973a"
            >
