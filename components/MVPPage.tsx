    ...
    <div className="bg-black text-white min-h-screen pt-32 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <header className="mb-20">
          <span className="text-gold text-[10px] font-black tracking-[0.5em] uppercase mb-4 block italic">Andalucía Talent</span>
          <h1 className="text-5xl md:text-8xl font-black uppercase italic tracking-tighter leading-none mb-8">EXPERIENCIA <br/> <span className="text-gold">MVP</span></h1>
          <p className="text-white/40 text-xl font-light uppercase tracking-widest max-w-3xl leading-relaxed">
            Tres días intensos para 24 talentos andaluces: entrenamientos de alto nivel con Berni Rodríguez y José Manuel Calderón en un entorno profesional.
          </p>
        </header>
