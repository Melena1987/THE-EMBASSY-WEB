  ...
  return (
    <section className="py-32 bg-black text-center reveal">
      <div className="max-w-4xl mx-auto px-6">
        <h2 className="text-4xl md:text-7xl font-black uppercase italic tracking-tighter mb-12 leading-none">ÚNETE AL <br/> <span className="text-orange-600">CAMPUS</span></h2>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
          <a href="#contacto" className="bg-orange-600 text-white px-16 py-8 rounded-full text-xs font-black uppercase tracking-[0.4em] hover:bg-white hover:text-black transition-all shadow-[0_20px_50px_rgba(234,88,12,0.3)]">
            SOLICITAR PLAZA
          </a>
          <button 
            onClick={onBack}
