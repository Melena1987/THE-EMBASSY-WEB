              ...
              <div className="relative overflow-hidden rounded-[2rem] mb-4 aspect-[4/5] bg-neutral-900 border border-white/5 group-hover:border-gold/30 transition-all duration-700">
                ...
                <div className="absolute top-4 right-4 flex flex-col space-y-2 translate-x-12 group-hover:translate-x-0 transition-transform duration-500 delay-100">
                  {member.socials.instagram && (
                    <a href={member.socials.instagram} className="w-9 h-9 bg-white/10 backdrop-blur-xl border border-white/10 rounded-full flex items-center justify-center hover:bg-gold transition-colors">
                  ...
                  {member.socials.twitter && (
                    <a href={member.socials.twitter} className="w-9 h-9 bg-white/10 backdrop-blur-xl border border-white/10 rounded-full flex items-center justify-center hover:bg-gold transition-colors">
